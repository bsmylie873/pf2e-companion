...
export default function SessionCard({ session, isGM, mode = 'list', onEdit, onDelete, onOpen }: SessionCardProps) {
  if (mode === 'grid') {
    return (
      <article className="session-card session-card--grid">
        ...
        <div className="session-card-grid-actions">
          ...
          {isGM && (
            <button className="session-card-btn session-card-btn--delete"
